class Car {
    ...
    Car(String brand, String model, String type, String mileage, int seat, float price, Engine engine) {
        this.brand = brand;
        this.model = model;
        this.type = type;
...
class CompoDriver2 {
    public static void main(String[] args) {
        // Engine engine = ;
        Car obj = new Car("TATA", "NEXON", "HATCHBACK", "17", 5, 850000,(new Engine("Diesel", 110.5, 4, 6)));
        obj.displayCar();
    }
}
